...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * - 오류(Error)와 달리 심각도가 낮으며, 예외처리(Exception Handling)을 통해
		 ...
		 *   => 만약, 일치하는 catch 블록이 업을 경우 프로그램은 비정상 종료됨.
		 ...
		 * 	 (Compile Unchecked Exception 계열 : RuntimeException 등
...
//											//at JAVA1020/exception.Ex.main(Ex.java:48)
//											// by zero=> 0에 의한 나눗셈으로 인해 예외 발생했다는 메세지
//											// (Ex.java:48) : Ex.java파일의 44번 라인에서 예오 ㅣ발생
//
//	      int[] arr = {1, 2, 3};

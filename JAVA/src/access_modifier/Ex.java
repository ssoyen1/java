...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * 	    			  ----------------------
		 * 					   -> 패키지 개념을 알아야 함
		 * 	 => 단, default 접근제한자는 별도의 키워드없이 생략하며 적용
		 * 
		 * 
		 * 
		 * 1. private 접근제한자
		 ...
		 *   => 파라미터는 없고, 리턴값만 있는 메서드 ( X O )
		 *   	ex) pubI mistook it for Sunday. Do you know we've been hanging around for almost 10 hours?lic int getNum() {}
		 *   
		 *   
		 * 2. Setter : 외부로부터 값을 전달받아 내부 멤버변수에 저장하는 메서드
		 * 	=> setXXX() 형식의 메서드 이름을 사용하여 정의
		 *	   이 때, XXX 는 접근할 멤버변수의 이름을 사용
		 *	   ex) 멤버변수 num에 접근하는 Seter 메서드 이름 : setNum()
		 *	=> 파라미터는 있고, 리턴값은 없는 메서드 ( O X )
		 *	   ex) public void setNum() {}
		 *	=> Getter/Setter 메서드 자동 생성 단축기
		 *		
		 *
		 * 
		 * 
...
//		p.name = "홍길동"; // The field Person.age is not visible
//		p.age = 20;
...
//		System.out.println("나이 : "+p.age);
		...
		System.out.println("이름 : "+p.getName()); // not visible

...
public class Ex4 {
	...
	public static void main(String[] args) {
				...
				System.out.println("정수 10을 2진수로 변환 : " + Integer.toBinaryString(num1)); //정수 10을 2진수로 변환 : 1010
				System.out.println("정수 10을 8진수로 변환 : " + Integer.toOctalString(num1));  //정수 10을 8진수로 변환 : 12
				System.out.println("정수 10을 16진수로 변환 : " + Integer.toHexString(num1));   //정수 10을 16진수로 변환 : a

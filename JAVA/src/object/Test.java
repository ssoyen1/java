...
public class Test {
	...
	public static void main(String[] args) {
		...
		if(s1 == s2) {
			System.out.println("s1과 s2는 주소값이 같다!"); //s1과 s2는 주소값이 같다!
		} else {
		...
		if(s1.equals(s2)) {
			System.out.println("s1과 s2는 문자열 내용이 같다!"); //s1과 s2는 문자열 내용이 같다!
		} else {
		...
		if(s3 == s4) {
			...
			System.out.println("s3와 s4는 주소값이 다르다!"); //s3와 s4는 주소값이 다르다!
		}
		...
		// 두 문자열의 내용 비교
		if(s3.equals(s4)) {
			System.out.println("s3와 s4는 문자열 내용이 같다!");
		} else {
		System.out.println("s3와 s4는 문자열 내용이 다르다!"); //s3와 s4는 문자열 내용이 같다!
		}

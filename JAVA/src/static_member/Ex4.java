...
public class Ex4 {
	...
	public static void main(String[] args) {
		 ...
		 * 	 클래스 내에서 직접 인스턴스를 생성 후 외부로 접근할 수 있도록 리턴하는 기법
		 ...
		 * 	  => private 접근제한자로 선언된 멤버변수 instance에 접근하여 생성된 인스턴스를 리턴하는 용도로 정의
...
//			SingletonClass sc = new SingletonClass();  // 1.에 private
//			SingletonClass sc2 = new SingletonClass(); // => The constructor SingletonClass() is not visible

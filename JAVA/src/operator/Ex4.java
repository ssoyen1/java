...
public class Ex4 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * - 단항연산자
		 * - 수치 데이터타입의 피연산자의 앞(좌측) 또는 뒤(우측)에 붙어서
		 ...
		 *    
		 *  2. 후행연산자(후위연산자)
		 * - 피연산자 앞(우측)에 위치하여 값을 1만큼 증가 또는 감소시킴
		 *   이 때, 다른 연산과 결합하여 사용하는 경우
...
//		a = a +1; // 컴파일에러 발생!(byte + int = int + int = int 이므로 저장불가)
		a = (byte)(a + 1); // 형변환 필요
		...
		System.out.println(x2); // x2 출력 시 7 출력 됨

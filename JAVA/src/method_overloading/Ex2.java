...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 * 	 => 메서드 호출 시 자신의 전달받은 파라미터를 다시 다른 오버로딩된 메서드에 전달
...
class PrintClass {
	// 최대 3명까지 초대 인원에 대한 이름을 전달받아 출력하는 print() 메서드 정의 
...
//		System.out.println("초대 멤버 : 없음 없음 없음");
	...
	public void print(String name1) {
		...
		System.out.println("초대 멤버 : "+name1+" 없음 없음");
									//		print(String) 메서드 호출됨!
									//		초대 멤버 : 홍길동 없음 없음
		
		
		// print(String,String,String) 메서드를 호출하여
		// 전달받은이름 없음 없음 문자열을 대신 출력 
		print(name1, " 없음", "없음");
									//		print(String) 메서드 호출됨!
									//		print(String, String, String) 메서드 호출됨!
									//		초대 멤버 : 홍길동 없음 없음
	}
	...
	public void print(String name1, String name2) {
		...
		System.out.println("초대 멤버 : "+name1+" "+name2+" 없음");
									//		print(String, String) 메서드 호출됨!
									//		초대 멤버 : 홍길동 이순신 없음
		
		// print(String,String,String) 메서드를 호출하여
		// 전달받은이름 전달받은 이름 없음 문자열을 대신 출력 

...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * => 생성되는 배열의 위치(주소값)를 선언한 배열 타입 변수에 저장
...
//		int scoreTotal = score1 + score2 + score3 + score4 + score5;
		...
		// 1. 배열 선언 : 데이터타입[] 배열명;
//		int[] score; // int형 정수여러개를 저장할 배열 score를 선언
		// => 아직 데이터를 저장할 수 있는 메모리 공간은 생성되기 전
//		score = 90; // 오류 발생 이름으로 사용되는 변수에 데이터 저장 불가!
...
//		score = new int[5];
		...
		// 해당 공간에 메모리 주소를 int[] 타입 변수 score에 저장
		...
		System.out.println(score); // 배열명을 그대로 출력시 주소값 출력(데이터X)
								   // [I@27f674d
		...
		// => 이 때, 배열은 자동으로 기본값을 초기화되므로 0 출력됨
		
		/*
		 * 주의 ! 생성된 배열의 인덱스 범위를 벗어나는 배열 접근 시 오류 발생!
		 * => 단, 문법적으로 오류가 아니기 때문에 코드상에서는 알 수 없고,
...
//		System.out.println(score[5]); // 실행 시 오류 발생! 
									  ...
									  // : 5번 인덱스가 범위를 벗어남
									  // at JAVA0919/array.Ex.main(Ex.java:101)
									  // : Ex.java 클래스의 89번 라인이 오류
		System.out.println("--------------------------------------");
...
//			System.out.println(score[i]); // score[0] ~ score[4] 까지 대응
		...
		// => 배열의 모든 인덱스 접근 시 조건식에 배열크기 직접 지정할 경우
